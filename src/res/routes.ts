...
export const ROUTE_DASHBOARD_COURSE = (id: string) => `${ROUTE_DASHBOARD_COURSES}/${id}`
export const ROUTE_DASHBOARD_COURSES_INFO = (id: string) => `${ROUTE_DASHBOARD_COURSES}/${id}/info`
