          ...
          <div className="relative bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-hidden">
            <div className="px-6 py-4 border-b bg-amber-50 border-amber-200 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <h3 className="text-lg font-semibold text-amber-900">{renderItemTitle(customItem)}</h3>
                <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-700">Custom</span>
              </div>
              <button
                type="button"
            ...
            <div className="px-6 py-4 overflow-y-auto max-h-[calc(90vh-150px)]">
              {customItem.description ? (
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: customItem.description }}
                />
              ) : (
