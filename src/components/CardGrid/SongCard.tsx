...
export interface ISongCard extends ICard {}

interface IProps {
  song: ISongCard
}

export default function SongCard({ song }: IProps) {
  const { title, content, imageUrl, organizationName, createdAt, tags, link, language } = song;
